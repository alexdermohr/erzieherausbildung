...
Synthese: Der Export ist deterministisch und Safe-List-basiert. Das Repo bleibt kanonisch; der Vault enthält nur abgeleitete View-Dateien. Pilotindex, Detail-Brückenindex und Theoriekatalog sind Quellenarbeits-, Orientierungs- und Denkflächen, keine Rohquellenablage.
...
- `docs/theory-catalog-v1.md` -> `Theoriekatalog.md`
