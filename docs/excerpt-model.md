...
## Synthese
Exzerpte bleiben kurz, quellenbezogen und nach Reifegrad markiert. `title-derived` ist Strukturhinweis, kein Inhaltsbeweis.

## Felder
ID, Lernfeld, Quellentitel, Fundstelle, Claim-Typ, Zusammenfassung, Begriffe, Praxisnutzen, Prüfungsbezug, Links, Reviewstatus, Unsicherheitsgrad.
